             ...
             double th1a, double th2a, double biasalpha, double qvac[4])
{
  ...
  if (!isInitialnized_not_empty) {
    ...
    dqacc_idx_2 = wy - by;
    dqacc_idx_3 = wz - bz;
    t = qvac_[0] - 0.005 * (((0.0 * qvac_[0] - dqacc_idx_1 * qvac_[1]) -
                             dqacc_idx_2 * qvac_[2]) -
                            dqacc_idx_3 * qvac_[3]);
    qw_idx_0 = t;
    bx = t * t;
    t = qvac_[1] - 0.005 * ((0.0 * qvac_[1] + qvac_[0] * dqacc_idx_1) +
                            (dqacc_idx_2 * qvac_[3] - qvac_[2] * dqacc_idx_3));
    qw_idx_1 = t;
    by = t * t;
    t = qvac_[2] - 0.005 * ((0.0 * qvac_[2] + qvac_[0] * dqacc_idx_2) +
                            (qvac_[1] * dqacc_idx_3 - dqacc_idx_1 * qvac_[3]));
    qw_idx_2 = t;
    bz = t * t;
    t = qvac_[3] - 0.005 * ((0.0 * qvac_[3] + qvac_[0] * dqacc_idx_3) +
